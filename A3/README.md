...
This project is an implementation of a load balanced sharded database system in Go that utilizes consistent hashing. The problem statement can be viewed [here](./DS_assign3_ConsistentDB.pdf).
...
```sh
git clone https://github.com/Kronos-192081/DistSys-Spr24.git && cd A3
```
